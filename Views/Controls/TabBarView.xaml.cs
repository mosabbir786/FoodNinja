...
namespace FoodNinja.Views.Controls;
...
public partial class TabBarView : ContentView
{
    ...
    public TabBarView()
    {
        ...
        barColor = Color.FromArgb("53E88B");
        circleColor = Color.FromArgb("FF8E4C");
        InitializeComponent();
    ...
    private void TabBarViewSizeChanged(object sender, EventArgs e)
    {
        if (initialChange)
        {
            ...
            foreach (var iconView in iconViews) iconView.TranslationY = defaultIconTranslation;
            initialChange = false;
        }
    ...
    private void Button_Tapped(object sender, EventArgs e)
    {
        ...
        }, oldIconView.TranslationY, defaultIconTranslation, easing: Easing.SinInOut);
