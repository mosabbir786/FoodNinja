...
public partial class BottomSheet : ContentView
{
    ...
    public event EventHandler BottomSheetClosed;
    public IList<Microsoft.Maui.IView> BottomSheetContent => BottomSheetContentGrid.Children;

    #region Bindable Properties
    public static readonly BindableProperty IsCancelButtonVisiblityProperty = BindableProperty.Create(
        nameof(IsCancelButtonVisible),
        typeof(bool),
        typeof(BottomSheet),true,
        propertyChanged: (bindable, oldValue, newValue) => {
            if (bindable is BottomSheet sheet && newValue is bool isVisible)
            {
                sheet.CloseBottomSheetButton.IsVisible = isVisible;
            }
        });
    public bool IsCancelButtonVisible
    {
        get => (bool)GetValue(IsCancelButtonVisiblityProperty);
        set
        {
            SetValue(IsCancelButtonVisiblityProperty, value);
            CloseBottomSheetButton.IsVisible = value;
        }
    }
    ...
    public BottomSheet()
	{
       ...
       // CloseBottomSheetButton.Source = ImageSource.FromResource($"XGENO.Maui.Controls.BottomSheet.icnmenuclose.png");
        CloseBottomSheetButton.Source = "icnmenuclosedark.png";
        CloseBottomSheetButton.IsVisible = IsCancelButtonVisible;
    }
    ...
    public async Task CloseBottomSheet()
    {
        ...
        BottomSheetClosed?.Invoke(this, EventArgs.Empty);
    }
